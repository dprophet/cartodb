  ...
  _initBinds: function() {
    ...
    this.contentCollection.bind('reset', function() {
      ...
      var updateNeeded = this._counts.all === undefined &&
          !(routerParams.category || routerParams.liked || routerParams.imported || routerParams.locked === 'true' || routerParams.samples || routerParams.q != '' || routerParams.tag != ''); // showing All
      if (updateNeeded) {
        this._updateCounts();
