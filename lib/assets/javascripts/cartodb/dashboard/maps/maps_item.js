...
module.exports = cdb.core.View.extend({
  ...
  _renderLikesIndicator: function() {
    var likes = this.model.get('likes') || 0;
    var view = new LikesView({
      model: new cdb.admin.Like.newByVisData({
          vis_id: this.model.get('id'),
          liked: likes > 0,
          likes: likes
        })
    });
    view.model.bind('toggled', function() {
      this.trigger('vis-states-changed');
    }, this);
    view.model.bind('change:likes', function() {
       this.model.set('likes', view.model.get('likes') || 0);
    }, this);
