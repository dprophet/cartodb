...
module.exports = cdb.core.View.extend({
  ...
  _initViews: function() {
    ...
    filtersView.bind('vis-states-changed', function() {
      updateCounts();
    });
  ...
  _onDataFetched: function() {
    var activeViews = ['sideMenu', 'filters'];
